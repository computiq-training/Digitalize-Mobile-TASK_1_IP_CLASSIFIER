...
def solution(): 
    ...
    if len(spip) == 4: 
         ...
         subip4 = int(x[0]) 
             ...
             print("The IP is not correct, Pleas Try again") 
             global count if count < 2: 
             solution() count = count + 1
              else: 
             print("Try agine after few mint...") sys.exit()
              else: 
                print("Please Enter IP in Correct way, like: xxx.xxx.xxx.xxx/xx")
                 if count < 2: count = count + 1 solution()
                  else:
                     print("Try agne after few second...")
                      sys.exit() 
                     try:
                          if ((subip1 > 255 or subip1 < 0) or (subip2 > 255 or subip2 < 0) or (subip3 > 255 or subip3 < 0) or ( subip4 > 255 or subip4 < 0)):
                             print("You Entered an incorrect Ip, Pleas Try again") 
                             if count <2:
                                 count = count + 1 
                                 solution()
                                  else: print("Try agine after few second...")
                                   sys.exit()
                                         ...
                                         print("Class: B, ",end='') 
                                             ...
                                             print("Class: C, ",end='') 
                                                 ...
                                                 print("Class: D, ",end='') 
                                                     ...
                                                     print("Class: E, ",end='') 
                                                     else: print("Wrong Value Please Enter Correct IP") 
                                                     if count < 2: count = count + 1 
                                                     solution() 
                                                     else: 
                                                        print("Try agne  after few minuts ...") 
                                                        sys.exit()
                                                          A=subip1 == 10 
                                                                 ...
                                                                 print("Designation: Private ",)
                                                                     ...
                                                                     print("Designation: Public ")
                                                                         ...
                                                                         print("Designation: Special ")
                                                                          else : print("Designation: Special ")
