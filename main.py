...
def solution():
    ...
    try:
        ...
        Ap = ((subip1 >= 1 and subip1 <= 9) or (
            subip1 >= 11 and subip1 <= 126))

        Bp = ((subip1 == 128) or (subip1 == 172 and (
            subip2 == 15 or subip2 == 32)) or (subip1 == 191 and subip2 == 255))

        Cp = ((subip1 == 192 and subip2 != 168) or (subip1 == 192 and (
            subip2 == 167 or subip2 == 169)) or (subip1 == 223))
